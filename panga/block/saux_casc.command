Segment file name: ./saux_casc.segment
Station file name: ./casc_pure_combined.sta.data
Sar file name: 
Block file name: ./saux_casc.block
...
Triangulated patch files: ../slip/mccrory_50km.mat
Type of a priori slip constraint (1 = slip values, 2 = coupling fraction): 0
Patch slip distribution files: 
Mesh smoothing weight: 15000 
Spatially variable smoothing weighted by resolution: 1
Smooth slip components individually (1) or simultaneously (2): 1
Constrain slip on [updip downdip lateral] limits: 0 1 0 
Depth tolerance for finding updip and downdip limits (km): 1
Constrained triangular slip weight: 10
...
Mogi source file: 
Solution method: tvr
Ridge regression parameter: 0
Ridge param: 110
Ridge param: 111
Lambda value for tvr estimator: 0.0005
